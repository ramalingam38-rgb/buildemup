...
Built per C6 SPEC v0.7 PROPOSED (S31 D-066 Step 7 critique-walk patch).
Cumulative changes from v0.5 LOCKED:
  v0.6 Q1-A: PlotDirection8 enum dropped (use PlotOrientation throughout)
  v0.6 Q1-B: Cardinal-only v1 facing; intercardinal raises NotImplementedError(B-107)
  v0.6 Q2:   CIRCULATION as private _circulation_score helper (NOT a FunctionRole)
  v0.7 CW-1: Architectural-invariant consolidation (new spec § 14.21).
             Doc-only patch: schema.py CARDINAL_FACINGS docstring expanded;
             select.py _validate_session guard comment added; vastu_kb.py
             module docstring cross-references § 14.21. ZERO BEHAVIOR CHANGE.
...
v0.7 patch: zero behavior change; identical 1725/1 result.
