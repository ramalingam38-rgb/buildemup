# ============================================================================
# BuildemUp C4 (Plot Analysis) — Consolidated Review Bundle (v1.0)
# ============================================================================
#
#  ★  GRADUATION MILESTONE — C4 ships at major version 1.0  ★
#
#  Five critique rounds (v0.5 → v0.6 → v0.7 → v0.8 → v0.9 → v1.0).
#  Most new critique items now resolve to either DUPLICATE (already in
#  backlog), PUSH-BACK (documented and stable across rounds), or small
#  hardening SPEC-AMENDMENTS that the architecture absorbs cleanly.
#  Net new backlog this round: ZERO. The architecture has converged.
#
# ============================================================================
#
# SPEC LINEAGE:
...
#   /mnt/user-data/outputs/buildemup_C4_SPEC_v0_7_LOCKED.md    (locked as v0.7)
#   /mnt/user-data/outputs/buildemup_C4_SPEC_v0_8_LOCKED.md    (locked as v0.8)
#   /mnt/user-data/outputs/buildemup_C4_SPEC_v0_9_LOCKED.md    (locked as v0.9)
#   /mnt/user-data/outputs/buildemup_C4_SPEC_v1_0_LOCKED.md    (this LOCK)
#
# Session: S29
# Status: 1419 passed / 2 skipped / 0 failed (was 1415/2/0 at v0.9 LOCK)
#
# THIS FILE IS NOT EXECUTABLE.
# Single-file CONCATENATION for code review only. Imports between modules
# look like cross-references after concat — do not try to run this file.
#
# ============================================================================
# CUMULATIVE TALLY ACROSS ALL FIVE CRITIQUE ROUNDS
# ============================================================================
#
#   22 SPEC-AMENDMENTS landed in code
#   17 backlog items filed (B-066..B-083 in this lineage; plus pre-S28)
#   11 push-backs documented and held
#
# Round-by-round velocity (declining new-backlog rate = convergence):
#   v0.5 (build):        6 amendments, --       backlog, --   push-backs
#   v0.6:                5 amendments, 5 new   backlog,  2  push-backs
#   v0.7:                4 amendments, 1 new   backlog,  2  push-backs
#   v0.8:                3 amendments, 2 new   backlog,  3  push-backs
#   v0.9:                1 amendment,  2 new   backlog,  2  push-backs
#   v1.0:                3 amendments, 0 new   backlog,  2  push-backs   ← ★
#
# ============================================================================
# ALL 17 BACKLOG ITEMS DEFERRED (filed; please do NOT re-flag in critique)
# ============================================================================
#
# Inline review markers also appear in 6 source file docstrings, so a
# critique reviewer can see them in context. Marker convention: each
# affected file has a '# ─── DEFERRED BACKLOG (REVIEW MARKER) ───' block.
# All blocks are pure comments — strippable after review-cycle close.
#
# ID      Description                                                Touches
# ------  ---------------------------------------------------------  --------------------------
# B-066   Polygon plots (v1: rectangular only)                       plot_analysis.py, schema.py
# B-067   Per-month sun-path (currently solstice envelope only)      sun_path.py
# B-068   effective_open_sides (post-setback openness)               neighbour_context.py
# B-069   Composite-zone sub-classification                          city_geography.py
# B-070   IMD wind-rose per city (full directional+intensity)        wind_direction.py
# B-071   Latitude-band city fallback for unknown cities             city_geography.py
# B-072   C7 retrofit to consume PlotAnalysis.soil_estimate          soil_city_defaults.py (target=C7)
# B-074   MEDIUM_ROCK proper kPa value (real ~1000-1500, used 660)   soil_estimator.py, soil_city_defaults.py
# B-075   AspectClass enum + extreme-plot flag                       plot_analysis.py, schema.py
# B-076   Plot.corner_orientation input field                        neighbour_context.py (target=C1/C3a)
# B-077   Richer multi-state soil confidence model                   soil_estimator.py
# B-078   System-wide trace_id lifecycle policy                      plot_analysis.py (target=Brief)
# B-079   System-wide KB_VERSION format policy                       soil_city_defaults.py (cross-cutting)
# B-080   Dynamic KB mutation re-validation                          plot_analysis.py (architecture)
# B-081   Perf-test rolling baseline / env-configurable threshold    test_c4_performance.py
# B-082   Structured kPa error fields on SoilEstimate                soil_estimator.py, schema.py
# B-083   Sub-city soil zoning (city_zone / geo_hash input)          soil_city_defaults.py (target=C1)
#
# Plus B-001..B-065 pre-S28 entries (carried unchanged).
#
# ============================================================================
# 11 PUSH-BACKS HELD (documented; please do NOT re-flag)
# ============================================================================
#
#   v0.6 #5  longitude omission rationale (mathematically irrelevant)
#   v0.6 #9  trace_id format at C4 (filed as B-078 — system-wide policy)
#   v0.7 #1  city normalization 'silent fail' framing (verify_kb_consistency
#            was already fail-fast)
#   v0.7 #5  aspect_ratio width-zero check (Plot.__post_init__ enforces 3-60m)
#   v0.8 #1  module-load coupling for wind_direction → wind_load (no cycle risk)
#   v0.8 #9  cross-KB semantic tests (would be tautological)
#   v0.8 #10 derive() 'god function' (80 LOC linear, no branches)
#   v0.9 #1  loosen import-time fail-fast (fail-fast IS the safety design)
#   v0.9 #8  plugin/extension hooks (YAGNI; zero current plugins)
#   v1.0 D6  corner_plot validation absence (Plot.__post_init__:132 has it)
#   v1.0 D7  atomic version-locking (no-op now or wrong in B-080 future)
#
# ============================================================================
# WHAT CHANGED IN v1.0 (vs v0.9 bundle)
# ============================================================================
# 3 SPEC-AMENDMENTS, 0 new backlog. Pure hardening round.
#
#  Walk #  Fix                                                  Files touched
#  ------  ---------------------------------------------------  ----------------------
#    D1    Float exact-eq → tolerance (1e-9) for area_sqft test test_c4_plot_analysis.py
#    D2    [DUPLICATE — already B-075]                          (no change)
#    D3    [DUPLICATE — push-back held since v0.6, 4 rounds]    (no change)
#    D4    PREVAILING_WIND direction PlotOrientation type check city_geography.py
#    D5    BEARING_CAPACITY_BY_TYPE per-soil kPa range check    city_geography.py
#    D6    [PUSH BACK — Plot.__post_init__:132 already raises]  (no change)
#    D7    [PUSH BACK — atomic version-lock no-op or B-080 reg] (no change)
#
# v0.9 → v1.0 SOURCE DELTA AT A GLANCE
#   city_geography.py:         +24 LOC  (D4 type loop + D5 range loop + docstring)
#   test_c4_plot_analysis.py:  +1  LOC  (== → tolerance comparison)
#   test_c4_kb_consistency.py: +50 LOC  (4 new drift tests for D4/D5)
#
# WHERE TO LOOK IF YOU ONLY HAVE 5 MINUTES
# ----------------------------------------
#   - kb/city_geography.py: verify_kb_consistency v1.0 additions
#                            (PlotOrientation type loop + per-SoilType kPa range)
#   - test_c4_plot_analysis.py: tolerance-based area_sqft assertion
#
...
# ============================================================================
# TABLE OF CONTENTS  (v1.0 bundle)
# ============================================================================
#
#   #  CATEGORY        PATH                                                     TOTAL   CODE
#
#   1  KB layer        kb/soil_city_defaults.py                                   200     82
#   2  C4 schema       components/c04/schema.py                                   371    262
#   3  KB layer        kb/wind_direction.py                                       106     58
#   4  KB layer        kb/city_geography.py                                       213    155
#   5  C4 logic        components/c04/sun_path.py                                 133     92
#   6  C4 logic        components/c04/climate_zone.py                              88     67
#   7  C4 logic        components/c04/soil_estimator.py                            94     61
#   8  C4 logic        components/c04/neighbour_context.py                        125     76
#   9  C4 logic        components/c04/plot_analysis.py                            279    184
#  10  C4 package      components/c04/__init__.py                                  50     44
#  11  Test fixtures   tests/validation/_c4_fixtures.py                            84     62
#  12  Tests           tests/validation/test_c4_plot_analysis.py                  593    445
#  13  Tests           tests/validation/test_c4_kb_consistency.py                 168    117
...
#  17  Tests           tests/validation/test_c4_property_based.py                  79     56
#  18  Tests           tests/validation/test_c5_consumes_plot_analysis.py          69     55
#
#       TOTALS          (18 files)                                                2827   1947
# ============================================================================
...
# LOC: 200 total, 82 non-blank/non-comment
# ============================================================================
...
# LOC: 371 total, 262 non-blank/non-comment
# ============================================================================
...
# LOC: 106 total, 58 non-blank/non-comment
# ============================================================================
...
# LOC: 213 total, 155 non-blank/non-comment
# ============================================================================
...
# LOC: 133 total, 92 non-blank/non-comment
# ============================================================================
...
# LOC: 94 total, 61 non-blank/non-comment
# ============================================================================
...
# LOC: 125 total, 76 non-blank/non-comment
# ============================================================================
...
# LOC: 279 total, 184 non-blank/non-comment
# ============================================================================
...
# LOC: 593 total, 445 non-blank/non-comment
# ============================================================================
...
# LOC: 168 total, 117 non-blank/non-comment
# ============================================================================
...
# LOC: 79 total, 56 non-blank/non-comment
# ============================================================================
