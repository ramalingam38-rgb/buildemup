...
def test_config_cache_relevant_partition_six_six() -> None:
    """Per § 2.6: 6 cache-relevant fields (enabled_operators,
    max_seeds_per_input, family_slot_allocations, deterministic_order,
    emit_base, deduplicate_by_signature) and 5 cache-irrelevant
    (enforcement_mode, provenance_verbosity, deep_mutation_cache_enabled,
    skip_pending_upstream_predicates, registry_validation_mode)."""
    import dataclasses
    cfg_fields = dataclasses.fields(TopologyMutationConfig)
