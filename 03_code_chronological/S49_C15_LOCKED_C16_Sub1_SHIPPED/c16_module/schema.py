...
class RoomGeometry:
    ...
    room_id:     str
    # Pinned at v1.0 LOCK — Sub-1 carries the seam only.
...
class WallSegment:
    identity:    ElementIdentity
    wall_id:     str
    element_kind: ElementKind   # WALL_EXTERNAL etc.
...
class DoorGeometry:
    identity:    ElementIdentity
    door_id:     str
    is_main_entry: bool = False  # Used by R29 orientation hierarchy step 2
