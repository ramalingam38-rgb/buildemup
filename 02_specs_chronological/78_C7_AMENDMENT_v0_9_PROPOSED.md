# C7 SPEC AMENDMENT v0.9 PROPOSED — `GridGenerator.generate()` target-bay kwargs (B-NEW-T2 enabler)

**Component**: 7 (Structural Grid Engine — SHIPPED at v0.8 LOCKED)
**Amendment status**: **v0.9 PROPOSED. PENDING Ramalingam LOCK adjudication.**
...
adjudication, file 79 in `02_specs_chronological/` will be either:
- `79_C7_AMENDMENT_v0_9_LOCKED.md` (if approved as-is),
- `79_C7_AMENDMENT_v0_10_PROPOSED.md` (if patches surfaced — Rule 8 patch-eligible
  until LOCK).
...
- **Patch-eligibility**: any critique surfaced before LOCK produces v0.10
  PROPOSED, not backlog (Rule 8 paragraph 4).
- **After LOCK**: code work begins on the C7 method, then M7 cascade, then
  tests, then end-of-session GAP/AUDIT/INTEGRITY.
