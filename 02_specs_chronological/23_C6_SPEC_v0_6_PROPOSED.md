# BuildemUp — C6 Orientation Priority — SPEC v0.6 PROPOSED
...
- **Status**: PROPOSED. PENDING Ramalingam LOCK adjudication. Pre-code patch round; not a critique walk.
- **Lineage**: v0.1 DRAFT → v0.2 PROPOSED (walk #1) → v0.3 PROPOSED (walk #2) → v0.4 PROPOSED (walk #3) → v0.5 PROPOSED (walk #4) → v0.5 LOCKED (Ramalingam, S30 close) → **v0.6 PROPOSED (S31 pre-code patch round)**
