# C11A SPEC AMENDMENT v1.6 LOCKED — multi-floor pipeline rework (B-NEW-T3 enabler #4 of 4)

**Component**: 11a (Topology Mutation Orchestration).
**Spec status**: **v1.6 LOCKED.** Ramalingam directive at S40-continuation: "Lock this and give me the handoff with everything that happened till now and make sure the next Claude starts coding immediately without any further delay."
**Authority**: Ramalingam directive. LOCK granted at v1.6 after 6 critique rounds. **All four B-NEW-T3 specs now LOCKED — build session can begin.**

**Convergence summary**: v1.1 first draft → v1.2/v1.3/v1.4 three-round behavioral-change sequence (dispatch axis, fairness algorithm, bipartite interleaving) → v1.5/v1.6 two-round doc-polish sequence. 18 backlog items filed across 6 rounds. Reviewer's final verdict on v1.5: "PRETTY CLOSE TO LOCK-WORTHY for v1 operational scope." v1.6 addressed the residual doc-polish items.

---

## § 0 — LOCK declaration

**v1.6 LOCKED at S40-continuation per Ramalingam directive.** All four B-NEW-T3 specs are now LOCKED. Build session can begin.
...
- **v1.6 LOCKED at S40-continuation per Ramalingam directive.**
- All four B-NEW-T3 specs LOCKED. Build session begins immediately.
...
**End of C11a Amendment v1.6 LOCKED. All four B-NEW-T3 specs LOCKED. Build begins.**
